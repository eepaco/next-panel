          ...
          `}
			>
				<div id="navbar-start-container" className="flex space-x-2">
					...
					<NavigationMenu.Item
						className="hover:bg-[--navbar-item-background-hover-color] focus:shadow-black flex items-center select-none px-2 cursor-pointer"
				...
				<div id="navbar-end-container" className="flex space-x-2">
					...
					<NavigationMenu.Item className="flex">
						...
						<NavigationMenu.Content className="data-[motion=from-start]:animate-[--enterFromLeft] data-[motion=from-end]:animate-[--enterFromRight] data-[motion=to-start]:animate-[--exitToLeft] data-[motion=to-end]:animate-[--exitToRight] absolute top-0 left-0 w-full sm:w-auto">
							<div className="sm:w-[250px] flex flex-col text-[--navbar-dropdown_menu_item-text-color]">
								<button className="hover:bg-[--navbar-dropdown_menu_item-background-hover-color] flex items-center p-2 text-sm">
									<Icon path={mdiLock} size={0.8} className="me-1" />A Button Here
								</button>
								<button className="hover:bg-[--navbar-dropdown_menu_item-background-hover-color] flex items-center p-2 text-sm">
